...
public class RatingAveragesTests extends TestCase {
	...
	public void testShouldCalculateAveragesWhenAllPeriodsHaveRatings() {
		MoodRatings ratings = new MoodRatings(
				new MoodRating(dateAndTime("04/06/2010 09:45"), 3, Cities.SYDNEY),
				new MoodRating(dateAndTime("22/07/2010 16:28"), 3, Cities.SYDNEY),
				new MoodRating(dateAndTime("17/08/2010 16:03"), 1, Cities.SYDNEY),
				new MoodRating(dateAndTime("09/09/2010 18:16"), 2, Cities.SYDNEY));
